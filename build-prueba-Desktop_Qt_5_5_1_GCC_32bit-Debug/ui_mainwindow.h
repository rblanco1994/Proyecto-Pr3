...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QObject::connect(cerrar, SIGNAL(clicked()), MainWindow, SLOT(close()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        cerrar->setText(QApplication::translate("MainWindow", "cerrar", 0));
